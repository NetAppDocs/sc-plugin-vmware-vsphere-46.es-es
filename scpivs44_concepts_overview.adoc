...
* Se requieren herramientas de ONTAP para VMware vSphere para proteger los equipos virtuales de VVol de VMware.
+
Use las herramientas de ONTAP para aprovisionar y configurar el almacenamiento para vVols en ONTAP y en el cliente web de VMware.
